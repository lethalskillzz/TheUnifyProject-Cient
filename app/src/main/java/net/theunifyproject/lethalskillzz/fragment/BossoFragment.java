 ...
 */
public class BossoFragment extends Fragment implements View.OnClickListener {
    ...
    private static String campus = "Bosso";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_bosso, container, false);
        ...
        progressBar = (ProgressBar) rootView.findViewById(R.id.fragment_bosso_progressBar);
        taxiCount =  (TextView) rootView.findViewById(R.id.bosso_taxi_count_btn);
        taxiCount.setOnClickListener(this);
        mChart = (BarChart) rootView.findViewById(R.id.bosso_chart);
        //mChart.setOnChartValueSelectedListener(this);
        mChart.setDrawBarShadow(false);
        mChart.setDrawValueAboveBar(true);
        mChart.setDrawValuesForWholeStack(false);
        mChart.setDescription("Bosso bus park");
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.bosso_taxi_count_btn: {
