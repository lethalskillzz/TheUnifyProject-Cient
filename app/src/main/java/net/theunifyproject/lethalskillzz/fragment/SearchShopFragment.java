 ...
 */
public class SearchShopFragment extends Fragment implements SearchView.OnQueryTextListener, SearchView.OnCloseListener{

    private static final String TAG = SearchShopFragment.class.getSimpleName();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_search_shop, container, false);
        ...
        rView = (RecyclerView) rootView.findViewById(R.id.search_shop_recycler_view);
        ...
        rView.getViewTreeObserver().addOnGlobalLayoutListener(
                new ViewTreeObserver.OnGlobalLayoutListener() {
                    ...
                    public void onGlobalLayout() {
                        ...
                        float cardViewWidth = getActivity().getResources().getDimension(R.dimen.shop_item_width);
        ...
        mSearchView = (SearchView) rootView.findViewById(R.id.search_shop_editor);
        setupSearchView();
    ...
    private void loadShopSearch(final String searchQuery, final String search_pos) {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST,
                AppConfig.URL_LOAD_SHOP_SEARCH, new Response.Listener<String>() {
