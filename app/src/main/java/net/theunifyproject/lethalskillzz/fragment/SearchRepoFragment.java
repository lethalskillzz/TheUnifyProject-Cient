 ...
 */
public class SearchRepoFragment extends Fragment implements SearchView.OnQueryTextListener, SearchView.OnCloseListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rView = (RecyclerView) rootView.findViewById(R.id.search_repo_recycler_view);
        ...
        mSearchView = (SearchView) rootView.findViewById(R.id.search_repo_editor);
        setupSearchView();
            ...
            public void onLoadMore() {
                if (!isRefreshing) {
                    ...
                    if (cd.isConnectingToInternet()) {
                        loadRepoSearch(searchQuery, String.valueOf(gridAdapter.getItemCount() - 1));
                    } else {
    ...
    public boolean onQueryTextChange(String newText) {
        if (TextUtils.isEmpty(newText)) {
            ...
            if (cd.isConnectingToInternet()) {
                isRefreshing = true;
                loadRepoSearch(searchQuery, String.valueOf(0));
            }else {
    ...
    private void loadRepoSearch(final String searchQuery, final String search_pos) {

        // making fresh volley request and getting json
        StringRequest strReq = new StringRequest(Request.Method.POST,
                AppConfig.URL_LOAD_REPO_SEARCH, new Response.Listener<String>() {
